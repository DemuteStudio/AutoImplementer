...
namespace GISB.Editor
{
    public class GISB_AudioClipJsonConverter : JsonConverter<AudioClip>
    {
        ...
        public override AudioClip ReadJson(JsonReader reader, Type objectType, AudioClip existingValue,
    ...
    public class GISB_EventRefJsonConverter : JsonConverter<List<GISB_Event>>
    {
        ...
        public override List<GISB_Event> ReadJson(JsonReader reader, Type objectType, List<GISB_Event> existingValue,
            bool hasExistingValue,
            JsonSerializer serializer)
        {
            ...
            while (reader.Read())
            {
                if (reader.TokenType == JsonToken.String)
                {
                    ...
                    GISB_Event gisbEvent =
                        AssetDatabase.LoadAssetAtPath<GISB_Event>(eventAssetsFolder + filename + ".asset");
                    if (gisbEvent == null)
                    {
